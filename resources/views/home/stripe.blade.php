...
<html>
<head>
    <title>It's Jolly Rogers Shop</title>
...
<div class="container">
    ...
    <h1 style="text-align:center; font-size: 18px; padding:20px"> It's Jolly Rogers Shop <br/> Pay using card - Total Amount ৳- {{$totalprice}}</h1>
            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    {{-- {{ route('stripe.post') }}   --}}
                        ...
                        {{-- ai je ai STRIPE_KEY ta env theke paisi --}}
                            id="payment-form">
                        @csrf
